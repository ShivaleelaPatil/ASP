...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row" style="background-color:blanchedalmond">
        <div class="col-md-4">
            ...
            <p>"Reading Hospital will be an innovative, leading regional health system dedicated to advancing the health and transforming the lives of the people we serve through excellent clinical quality; accessible, patient-centered, caring service; and unmatched physician and employee commitment."
            </p>
            <p>
        ...
        <div class="col-md-4">
            ...
            <p>.The Mission of Reading Hospital is to provide compassionate, accessible, high quality, cost effective healthcare to the community; to promote health; to educate healthcare professionals; and to participate in appropriate clinical research.
            </p>
            <p>
                <a class="btn btn-default" href="https://reading.towerhealth.org/about/leadership/">Learn more &raquo;</a>
            </p>
        </div>
        <div class="col-md-4">
            <h2>Core Values</h2>
